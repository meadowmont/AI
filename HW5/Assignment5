...
GAMMA = 0.30           # Discount Factor (how much future rewards matter) I changed to 0.5, 0.8, and 0.99.
...
EPS_DECAY = 5000           # Keeping this aggressive decay value as requested. I changed to 2500 and 1250.
...
def run_visualizer():
    ...
    # Produce Summary Graphs (shown in write-up)
